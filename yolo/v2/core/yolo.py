...
class YoloV2:
    ...
    @classmethod
    def body(cls, inputs, num_anchors, num_classes):
        """
    ...
    def head(cls, feats, anchors, num_classes):
        ...
        Returns
        -------
        :return box_xy: [tensor] x, y box predictions adjusted by spatial location in conv layer.
        :return box_wh: [tensor] w, h box predictions adjusted by anchors and conv spatial resolution.
        :return box_conf: [tensor] Probability estimate for whether each box contains any object.
        :return box_class_pred: [tensor] Probability distribution estimate for each box over class labels.
        """
    ...
    @classmethod
    def loss_function(cls, args, anchors, num_classes, rescore_confidence=False, print_loss=False):
